...
class Config:
    ...
    news_max_searches_per_stock: int = 2  # 单只股票新闻/舆情搜索轮数，调高更全但更慢
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        return cls(
            ...
            news_max_searches_per_stock=parse_env_int(
                os.getenv('NEWS_MAX_SEARCHES_PER_STOCK'),
                2,
                field_name='NEWS_MAX_SEARCHES_PER_STOCK',
                minimum=0,
                maximum=5,
